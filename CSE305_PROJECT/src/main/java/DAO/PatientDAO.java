    ...
    public void saveDataByChar(ArrayList<Patient> list) {
        ...
        try {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                String line = dOB + "," + job + "," + insurance + "," + height + "," + weight + "," + bloodType + "," + userName + "," + name + "," + phoneNumber + ","
    ...
    public ArrayList<Patient> restoreDataFromChar() {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Patient patient = new Patient(temp[0], temp[1], temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11]);
